...
python tools/test_modified_argo.py \
	...
	--config "/data2/nsathish/mmdetection-yolo/configs/yolo/yolov3_d53_mstrain-416_273e_coco.py" \
	--weights "/data2/nsathish/mmdetection-yolo/checkpoints/yolov3_d53_mstrain-416_273e_coco-2b60fcd9.pth" \
	--in-scale 1.0 \
