...
python tools/test_modified_argo.py \
	...
	--weights "/data2/nsathish/results/work_dirs/mrcnn_r50_anchor/epoch_24.pth" \
	--in-scale 1.0 \
	--out-dir "/data2/nsathish/Exp/Argoverse-HD/output/mrcnn50_nm_v2.4_s1.0_anchorscale_12/val" \
