...
python tools/test_modified_argo.py \
	...
	--weights "/data2/nsathish/results/work_dirs/frcnn_r50_multi_scale_608_4x/epoch_48.pth" \
	--in-scale 1.0 \
	--out-dir "/data2/nsathish/Exp/Argoverse-HD/output/frcnn50_nm_v2.4_s1.0_multi_scale_608_4x/val" \
